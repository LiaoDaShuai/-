...
<div class="container col-sm-11 container-bianju">
    <div class="row" style="box-shadow: inset 0 -2px 0 0 #eee;">
        ...
        <a href="/wyht/yezhu/all?status=1">
            <div class="navkuai"  style="border-bottom: 2px solid #7a7a7a;">未通过</div></a>
            ...
            <tbody style="text-align:center;">
                ...
                <tr style="font-size: 14px;">
                    ...
                    <td>
                       ...
                       <a class="onClickhand" onclick="update_status('再次迁入','${yz.oid}','2')"><i class="fa fa-sign-in"></i> 迁入房屋</a>
                    </td>
                </tr>
                </c:forEach>
            </tbody>
