		...
		<div class="sj-item"
			...
			<div class="sj-top"
				...
				<div class="sj-num" style="position: absolute; top: 10px; right: 0; width: 25%; text-align: left; height: 40px; line-height: 30px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
					<b>No:</b><span
						style="font-size: 20px; font-weight: 600; color: #F1352A;">${list[0].unpaino }</span>
				</div>
			</div>
			<div class="sj-else"
				...
				<div class=""
					...
					<label style="font-weight: 600;">小区：</label>${list[0].district.dname }
				</div>
				<div class=""
					style="float: left; width: 31%; text-align: left; font-size: 14px;">
					<label style="font-weight: 600;">姓名：
						${list[0].ownerlist[0].owername }
						</label>
				</div>
				<div class=""
					style="float: left; width: 31%; text-align: left; font-size: 14px;">
					<label style="font-weight: 600;">打印日期：</label>${list[0].nowdate }
				</div>
			</div>
			</header>
			...
			<div class=""
				...
				<label style="font-weight: 600;">说明：</label>所有款项请限缴费日期之前缴清，否则将依合同每天按0.1%滞纳金收取。
			</div>
			</footer>
		</div>
	</div>
