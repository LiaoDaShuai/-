...
<title>启源后台管理系统</title>
    <script type="text/javascript" src="/wyht/js/courier/express_co.js"></script>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12" style="background:#fff; margin-bottom:10px;">
                        <div class="pull-left">
                            <a type="button" class="btn btn-success" data-toggle="modal" href="#add-co">
                                <i class="fa fa-plus"></i>&nbsp;添加快递公司
                            </a>
                        </div>
                        <form name="f1" action="/wyht/express/companyByC" method="post">
	                        <input type="hidden" name="pageNum" value=""> 
							<input type="hidden" name="pageSize" value="${page2.size }">
	                        <div class="pull-right">
	                            <div class="suotext">
	                                <input type="text" name="keywords" value="${ecompany.keywords }" class="wentext" placeholder="快递公司/添加人">
                    ...
                    <div class="com-md-12">
                        <table class="table table-hover text-center">
                            ...
                            <tbody>
                            <c:forEach items="${page.list}" var="ec">
                            <tr>
	                            <td>${ec.expgsName }</td>
	                            <td><a href="javascript:cer_manage(${ec.expgsId })">${ec.expgsCouriers }人</a></td>
	                            <td>${ec.expgsTjiaperson }</td>
	                            <td><fmt:formatDate value="${ec.expgsTjiadate }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	                            <td>
	                                <a class="btn btn-default btn-icon-text user-edit" data-toggle="modal" href="#edit-co" onclick="edit(${ec.expgsId })">
	                                    <i class="fa fa-edit"></i>编辑
	                                </a>
	                                <a class="btn btn-default btn-icon-text" onclick="after_delete(${ec.expgsId })">
...
<!-- 添加快递公司 -->    
<div class="modal fade" id="add-co" data-backdrop="static">
    <div class="modal-dialog" style="margin-top:150px;" >
        <div class="modal-content">
            ...
            <form class="layui-form" action="/wyht/express/addCompany" name="f2">
	            <div class="modal-body">
	                <div class="layui-form-item">
	                    ...
	                    <div class="layui-input-block">
	                        <input type="text" class="layui-input" name="expgsName" id="expgsName2" onblur="epnamever()">
	                    </div>
	                </div>
	            </div>
...
<!-- 编辑快递公司 -->
<div class="modal fade" id="edit-co" data-backdrop="static">
    <div class="modal-dialog" style="margin-top:150px;" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close ref" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <form class="layui-form" action="/wyht/express/updateCompany" name="f3">
            	<input type="hidden" name="expgsId" id="expgsId3">
	            <div class="modal-body">
	                <div class="layui-form-item">
	                    <label class="layui-form-label">
	                        	公司名称：
	                    ...
	                    <div class="layui-input-block">
	                        <input type="text" class="layui-input" name="expgsName" id="expgsName3">
	                    </div>
	                </div>
	            </div>
	            <div class="modal-footer">
